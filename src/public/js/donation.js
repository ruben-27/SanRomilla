...
(function () {
  ...
  */
  ...
  function showInsert() {
    alert("aa"); //Variable que guarda la acción que queramos hacer al realizar la petición
  ...
  function insert() {
    ...
    var str = [];
    str = $("#inscriptionDonation").serialize();
    console.log(str); //Petición

    $.get('/donationInsert', str, function (data) {
      if (data == "OK") {
        location.reload;
      } else {
        alert(data);
