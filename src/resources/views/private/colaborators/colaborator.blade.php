<x-app-layout>
    ...
    <div class="h-full md:w-10/12 md:mx-auto mt-14 mb-10 px-6 md:px-0">
        <div class="mt-8 flex flex-col items-center md:flex-row md:justify-between">
            ...
            <a href="{{route('colaborator_showInsert')}}" class="flex bg-yellow-500 rounded font-bold text-white px-4 py-3 transition duration-300 ease-in-out hover:bg-yellow-600">
