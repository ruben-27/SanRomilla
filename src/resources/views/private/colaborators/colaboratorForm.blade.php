        ...
        <div class="flex items-center justify-center mt-8">
            <div class="grid bg-white rounded-lg shadow-xl w-full sm:w-12/12 lg:w-10/12 xl:w-9/12 px-3 md:px-7">
                <div class="flex justify-center py-4">
                    <div class="flex bg-yellow-200 rounded-full md:p-4 p-2">
                        <svg fill="none"
                ...
                {{ csrf_field() }}
                    ...
                    <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                        <a href="{{route('colaborator')}}" class='w-auto bg-gray-500 hover:bg-gray-700 rounded uppercase shadow-xl font-medium text-white px-4 py-2' id="cancel">Cancelar</a>
