                ...
                <div class="grid bg-white rounded-lg shadow-xl w-full sm:w-12/12 lg:w-8/12 xl:w-6/12 px-3 md:px-7">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="grid grid-cols-1 mt-5">
                            ...
                            <input class="py-2 px-3 rounded-lg border-1 border-gray-200 mt-1 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent placeholder:text-gray-300" value="{{ isset($category) ? $category->price : ''}}" type="number" min="1" step="any"  name="price" />
                        </div>
