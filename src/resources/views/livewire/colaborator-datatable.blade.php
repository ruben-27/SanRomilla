<div>
    <div class="mt-8 flex flex-col items-center md:flex-row md:justify-between">
        ...
        <button wire:click="$emit('openModal', 'modal.colaborators.add-colaborator')" class="flex bg-yellow-500 rounded font-bold text-white px-4 py-3 transition duration-300 ease-in-out hover:bg-yellow-600">
                            ...
                            <tr class="border-b border-gray-200 even:bg-gray-50 hover:bg-gray-100">
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <span>{{$colaborator->name}} {{$colaborator->last_name}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <a wire:click="$emit('openModal', 'modal.colaborators.add-colaborator', {{ json_encode(['colaborator' => $colaborator->id]) }})">
                                        ...
                                        <a wire:click="$emit('openModal', 'modal.colaborators.delete-colaborator', {{ json_encode(['colaborator' => $colaborator->id]) }})">
