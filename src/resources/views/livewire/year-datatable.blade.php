<div>
    <div class="mt-8 flex flex-col items-center md:flex-row md:justify-between">
        ...
        @if($activeYear)
            <button wire:click="$emit('openModal', 'modal.years.end-year', {{ json_encode(['year' => $activeYear->id]) }})" class="flex bg-yellow-500 rounded font-bold text-white px-4 py-3 transition duration-300 ease-in-out hover:bg-yellow-600">
                Finalizar Año
            </button>
        @else
            <button wire:click="$emit('openModal', 'modal.years.add-year')" class="flex bg-yellow-500 rounded font-bold text-white px-4 py-3 transition duration-300 ease-in-out hover:bg-yellow-600">
                            ...
                            <tr class="border-b border-gray-200 even:bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center">
                                    ...
                                    <div class="flex item-center justify-center">
                                        <a wire:click="$emit('openModal', 'modal.years.add-year', {{ json_encode(['year' => $year->id]) }})">
                                        ...
                                        <a wire:click="$emit('openModal', 'modal.years.delete-year', {{ json_encode(['year' => $year->id]) }})">
