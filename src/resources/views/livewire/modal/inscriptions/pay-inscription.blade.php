<div>
    ...
    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        <button type="button" wire:click="$emit('openModal', 'modal.inscriptions.insert-dorsal-inscriptions', {{ json_encode(['inscription_number' => $inscription->inscription_number]) }})" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-yellow-500 text-base font-medium text-white hover:bg-yellow-600 sm:ml-3 sm:w-auto sm:text-sm">Pagar Todas</button>
