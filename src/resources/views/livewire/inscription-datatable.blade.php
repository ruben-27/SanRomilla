    ...
    <div class="mt-8 flex flex-col items-center md:flex-row md:justify-between">
        <div>
            ...
            <p class="hidden md:block">
                Gestión de inscripciones del año {{$activeYear->year}}
            </p>
        </div>
        @if($this->inInscriptionsDate() && $this->maxPeople())
        ...
        @elseif($this->inInscriptionsDate())
        <p class="text-gray-500">
            Ya no pueden inscribirse más personas
        </p>
        @else
        <p class="text-gray-500">
            El plazo para inscribirse ha finalizado
        </p>
        @endif
    </div>
