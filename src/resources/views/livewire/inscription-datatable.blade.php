    ...
    <div class="w-full">
        <div class="bg-white shadow-md rounded my-6 overflow-x-auto">
            ...
            <div class="p-4 flex flex-col lg:flex-row justify-between items-center bg-gray-50">
                ...
                <div class="w-full flex flex-col justify-center items-center lg:justify-between lg:items-start 2xl:flex-row 2xl:justify-around 2xl:items-center">
                    {{-- Per Page --}}
                    <div>
                        Resultados: &nbsp;
                ...
                <div class="w-full flex flex-col justify-around items-center lg:justify-between lg:items-end 2xl:flex-row 2xl:justify-around 2xl:items-center">
                    {{-- Paid --}}
                    <div class="mt-6 lg:mt-0">
                        Pagado: &nbsp;
                        <select wire:model="paid" class="py-1 bg-gray-100 border border-gray-300 text-gray-900 rounded focus:ring-yellow-500 focus:border-yellow-500">
                            <option value="">Todas</option>
