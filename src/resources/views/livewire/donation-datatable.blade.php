<div>
    <div class="mt-8 flex flex-col items-center md:flex-row md:justify-between">
        ...
        <button wire:click="$emit('openModal', 'modal.donations.add-donation')" class="flex bg-yellow-500 rounded font-bold text-white px-4 py-3 transition duration-300 ease-in-out hover:bg-yellow-600">
